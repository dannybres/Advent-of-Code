%% day5puzzle1 - Daniel Breslan - Advent Of Code 2022
...
for idx = 1:size(instructions,1) % loop through instuctions
    stringToMove = positions(instructions(idx,2))...
        ...
        instructions(idx,1)).reverse(); % find crates to move and reverse
...
day5puzzle1result = positions.extractAfter(strlength(positions)-1)...
