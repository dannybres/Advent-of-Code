%% day17puzzle2 - Daniel Breslan - Advent Of Code 2022
clear
clc
gusts = readlines("input.txt").replace(["<",">"],["-1,","1,"])...
    .split(",").double';
gusts(end) = [];
...
for nextPieceIdx = 1:blocks
    ...
    if nextPieceIdx > 5
        ...
        startingPoint(nextPieceIdx,:) = [NextPieceToFall, gustIdx,...
            finalPieces(:)'];
    end
    ...
    for idx = 1:3
        [nextPiece, gustIdx] = movePieceSide(nextPiece, atRest,gusts,...
            gustIdx);
