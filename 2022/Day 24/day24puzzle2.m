%% day24puzzle2 - Daniel Breslan - Advent Of Code 2022
...
[j1, bliz] = tranverseMe(bliz, startingCol, endingCol);
[j2, bliz] = tranverseMe(flipud(bliz), endingCol, startingCol);
[j3, bliz] = tranverseMe(flipud(bliz), startingCol, endingCol);
day24puzzle2result = j1 + j2  + j3 %#ok<NOPTS> 
