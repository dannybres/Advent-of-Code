...
path = shortestpath(g, "200_0", oxygenSystem(1) + ...
    "_" + oxygenSystem(2))';
day15puzzle1result = numel(path) %#ok<NOPTS> 
% 167 - your answer is too low
...
plot(oxygenSystem(:,1),oxygenSystem(:,2),'ro',MarkerSize=8,MarkerFaceColor="red")
shg
%%
...
for input = 1:4
    ...
    [nextSquare, data, nextMemoryAddress, ~, relativeBase] = ...
        processIntCodeComputer(data,input,...
        1,nextMemoryAddress, relativeBase);
